...
grudge_cycle = {
	...
	target_grudge_goal = 50000,
	settled_grudges_total = 0,
	unit_roll_base_chance = 5,
	...
	share_reward_prefix = "wh3_dlc25_grudge_cycle_",
...
function grudge_cycle:update_settled_grudges_total()
	...
	for _, k in pairs(get_key_sorted(self.cycle_grudges)) do
